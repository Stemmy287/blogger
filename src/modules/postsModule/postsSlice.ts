...
export const fetchPostsTC = createAsyncThunk('postsModule/fetchPosts', async (param, {
  dispatch,
  rejectWithValue,
  getState
}) => {
...
export const fetchPostTC = createAsyncThunk('postsModule/fetchPost', async (param: { postId: string }, {
  dispatch,
  rejectWithValue
}) => {
  try {
